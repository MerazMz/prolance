 ...
 */
const SEOHelmet = ({
    title = 'Prolance - Freelance Marketplace',
    description = 'Connect with top freelancers or find your next project on Prolance. The premier platform for freelance work worldwide.',
    keywords = 'freelance, marketplace, freelancers, projects, hire, remote work, gig economy',
    ogType = 'website',
    ogImage = 'https://prolance.meraz.me/og-image.png',
    canonicalUrl = '',
    noindex = false,
    structuredData = null,
}) => {
