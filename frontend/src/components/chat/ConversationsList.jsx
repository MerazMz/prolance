            ...
            {conversations.map((conversation) => {
                ...
                return (
                    <button
                        ...
                        className={`w-full px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700 transition text-left ${isSelected ? 'bg-green-50 dark:bg-green-900/20 border-l-2 border-green-600' : ''
                            }`}
                    >
