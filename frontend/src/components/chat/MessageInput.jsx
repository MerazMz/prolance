        ...
        <form onSubmit={handleSubmit} className="px-6 mt-4 p-2 ">
            <div className="flex items-end gap-3">
                ...
                <button
                    ...
                    className="p-3 bg-green-600 dark:bg-green-500 text-white rounded-xl hover:bg-green-700 dark:hover:bg-green-600 transition disabled:bg-gray-300 dark:disabled:bg-gray-700 disabled:cursor-not-allowed shadow-sm"
                    title="Send message"
                >
