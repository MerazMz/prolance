                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex-1">
                                    <select
                                        ...
                                        className="w-full px-4 py-3 text-sm border border-gray-200 rounded-lg focus:border-green-600 focus:outline-none font-light bg-white cursor-pointer"
                                    >
                                ...
                                <div className="flex-1">
                                    <div className="grid grid-cols-3 gap-3">
                                        ...
                                        <select
                                            ...
                                            className="px-4 py-3 text-sm border border-gray-200 rounded-lg focus:border-green-600 focus:outline-none font-light bg-white cursor-pointer"
                                        >
