            ...
            <div className="max-w-6xl mx-auto px-8 py-10">
                ...
                >
                    ...
                    <div className="flex items-center justify-between gap-6 mb-6">
                        {/* Left: Title */}
                        <div>
                            <h1 className="text-3xl text-left font-light text-gray-700 dark:text-gray-200">Explore Projects</h1>
                            <p className="text-gray-600 dark:text-gray-400 text-left text-xs">Find the perfect project for you</p>
                        </div>
                        ...
                        <form onSubmit={handleSearch} className="flex items-center gap-2 flex-1 justify-end relative">
                            ...
                            <div ref={filterDropdownRef} className="relative w-72 flex-shrink-0">
                                ...
                                {showFilters && (
                                    <motion.div
                                        ...
                                        animate={{ opacity: 1, y: 0 }}
                                        exit={{ opacity: 0, y: -10 }}
                                        className="absolute top-full mt-2 left-0 w-full bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg p-4 z-50"
                                    >
                ...
                <div>
                    ...
                    {activeTab === 'trending' && isAuthenticated && (
                        ...
                        >
                            {trendingProjects.length === 0 ? (
                                <div className="text-center py-16 border border-gray-100 dark:border-gray-800 rounded-lg">
                                ...
                                <div className="relative px-12">
                                    ...
                                    <button
                                        ...
                                        className="absolute left-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-full hover:bg-gray-50 dark:hover:bg-gray-700 transition cursor-pointer shadow-md flex items-center justify-center"
                                    >
                                    ...
                                    <button
                                        ...
                                        className="absolute right-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-full hover:bg-gray-50 dark:hover:bg-gray-700 transition cursor-pointer shadow-md flex items-center justify-center"
                                    >
                                    ...
                                    >
                                        ...
                                        <div className="flex-shrink-0 w-80 opacity-0 pointer-events-none"></div>
                                        ...
                                        {trendingProjects.map((project, index) => {
                                            ...
                                            return (
                                                <div
                                                    key={project._id}
                                                    className="flex-shrink-0 w-80 transition-all duration-500 ease-out snap-center"
                                                    style={{
                    ...
                    {activeTab === 'bestMatch' && isAuthenticated && (
                        ...
                        >
                            {!hasSkills ? (
                                <div className="border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 rounded-lg p-8 text-center">
                                    ...
                                    {projects.map((project, index) => (
                                        ...
                                        >
                                            <Link
                                                ...
                                                className="flex border border-gray-100 dark:border-gray-800 hover:border-green-500 hover:dark:border-green-500 rounded-lg overflow-hidden hover:border-gray-300 dark:hover:border-gray-600 hover:shadow-md transition-all bg-white dark:bg-gray-900 group"
                                            >
                                                {/* Thumbnail */}
                                                {project.thumbnail ? (
                                                    <img
                                                        ...
                                                        alt={project.title}
                                                        className="w-48 h-36 object-cover bg-gray-100 dark:bg-gray-800 flex-shrink-0"
                                                    />
                                                ) : (
                                                    <div className="text-center w-48 h-36 bg-gradient-to-br from-gray-50 to-green-50 dark:from-gray-800 dark:to-green-900/20 flex items-center justify-center flex-shrink-0">
...
function TrendingProjectCard({ project, index, getTimeSince }) {
    return (
        ...
        >
            <Link
                to={`/projects/${project._id}`}
                className="block border border-gray-200 dark:border-gray-700 hover:border-green-500 dark:hover:border-green-500 rounded-2xl overflow-hidden hover:shadow-xl transition-all bg-white dark:bg-gray-900 group h-full"
            >
                {/* Large Thumbnail - Top */}
                <div className="w-full h-60 bg-gray-100 dark:bg-gray-800">
                    {project.thumbnail ? (
                        ...
                        <div className="w-full h-full bg-gradient-to-br from-green-100 to-gray-50 dark:from-green-900/30 dark:to-gray-800 flex items-center justify-center">
                ...
                <div className="p-5">
                    {/* Title */}
                    <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2 group-hover:text-green-600 dark:group-hover:text-green-500 transition line-clamp-2 min-h-[3.5rem]">
                        {project.title}
                    </h3>
                    ...
                    {/* Description */}
                    <p className="text-sm text-gray-600 dark:text-gray-400 font-light mb-4 line-clamp-2 min-h-[2.5rem]">
                        {project.description}
                    </p>
    ...
    if (highlight) {
        return (
            ...
            >
                <Link
                    to={`/projects/${project._id}`}
                    className="flex border border-gray-200 dark:border-gray-700 dark:hover:border-green-500 hover:border-green-500 rounded-xl overflow-hidden hover:shadow-lg transition-all bg-white dark:bg-gray-900 group h-full"
                >
                    {/* Thumbnail - Left Side */}
                    <div className="w-32 h-40 flex-shrink-0 bg-gray-100 dark:bg-gray-800">
                        {project.thumbnail ? (
                            <img
                                src={project.thumbnail}
                                alt={project.title}
        ...
        >
            ...
            >
                ...
                {project.thumbnail ? (
                    ...
                    <div className="w-full h-40 bg-gradient-to-br from-gray-50 to-green-50 dark:from-gray-800 dark:to-green-900/20 flex items-center justify-center">
                ...
                <div className="p-4">
                    <div className="mb-3">
                        <h3 className="text-base min-h-[3rem] text-gray-700 dark:text-gray-300 hover:text-green-600 dark:hover:text-green-500 font-light mb-1.5 line-clamp-2 transition">
                            {project.title}
                        </h3>
                    ...
                    <p className="text-sm mb-3 min-h-[2.5rem] text-gray-600 dark:text-gray-400 line-clamp-2 font-light">
                        {project.description}
                    </p>

                    <div className="flex flex-wrap gap-1.5 min-h-[1.5rem] mb-3">
                        {project.skillsRequired.slice(0, 3).map((skill, idx) => (
                            <span
                                key={idx}
                                className="px-2 py-0.5 bg-gray-50 dark:bg-gray-800 text-gray-600 dark:text-gray-300 text-xs rounded border border-gray-100 dark:border-gray-700 font-light"
