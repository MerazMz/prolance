        ...
        <div className="min-h-screen bg-white">
            <div className="max-w-7xl mx-auto px-6 py-8">
                ...
                <motion.div
                    ...
                    className="bg-white rounded-lg border border-gray-100 p-5 mb-6"
                >
                    {/* Search Bar */}
                        ...
                        {freelancers.map((freelancer, index) => (
                            ...
                            >
                                <Link
                                    ...
                                    className="block bg-white rounded-lg border border-gray-100 p-4 transition-all duration-300 h-60 flex flex-col relative overflow-hidden cursor-pointer group-hover:shadow-xl group-hover:border-gray-200"
                                >
