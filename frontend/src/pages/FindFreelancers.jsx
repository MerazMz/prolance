            ...
            <div className="max-w-6xl mx-auto px-8 py-10">
                ...
                >
                    ...
                    <div className="flex items-center justify-between gap-6 mb-6">
                        {/* Left: Title */}
                        <div>
                            <h1 className="text-left text-3xl font-light text-gray-700 dark:text-gray-200">Find Freelancers</h1>
                            <p className="text-left text-xs text-gray-500 font-light">Discover talented professionals for your projects</p>
                        </div>
                ...
                {loading ? (
                    ...
                    <div className="text-center py-16 border border-gray-100 dark:border-gray-800 rounded-lg bg-white dark:bg-gray-900">
                        ...
                        {freelancers.map((freelancer, index) => (
                            ...
                            >
                                <Link
                                    ...
                                    className="block bg-white dark:bg-gray-900 rounded-lg border border-gray-100 dark:border-gray-800 p-4 transition-all duration-300 h-60 flex flex-col relative overflow-hidden cursor-pointer group-hover:shadow-xl group-hover:border-gray-200 dark:group-hover:border-gray-700"
                                >
                                    {/* Hover Gradient Overlay */}
                                    <div className="absolute inset-0 bg-gradient-to-br from-gray-50/0 via-gray-50/0 to-gray-100/0 group-hover:from-gray-50/50 group-hover:via-gray-50/30 group-hover:to-gray-100/50 dark:from-gray-800/0 dark:via-gray-800/0 dark:to-gray-900/0 dark:group-hover:from-gray-800/50 dark:group-hover:via-gray-800/30 dark:group-hover:to-gray-900/50 transition-all duration-500 pointer-events-none" />
                                    ...
                                    <div className="relative z-10 flex flex-col h-full">
                                        ...
                                        <motion.div
                                            className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-white/95 via-white/90 to-transparent dark:from-gray-900/95 dark:via-gray-900/90 dark:to-transparent backdrop-blur-sm p-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
                                            initial={{ y: 20 }}
                                            whileHover={{ y: 0 }}
                                        >
